...
Slang like this only clicks when you hear it in real conversations. Our [Short Stories in Peruvian Spanish](https://shop.digitalpolyglot.com/products/short-stories-in-peruvian-spanish) drop these words into everyday Lima scenes, so you learn the rhythm and the context, not just a list.
...
3. **Meet the words in context.** The [Peruvian Spanish Phrasebook](https://shop.digitalpolyglot.com/products/peruvian-spanish-phrasebook) gives you the everyday language these expressions live inside.
