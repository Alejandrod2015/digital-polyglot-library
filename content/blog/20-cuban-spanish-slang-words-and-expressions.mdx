...
heroCredit:
  ...
  source: "https://commons.wikimedia.org/wiki/File:National-Capitol-and-classic-cars-in-Havana-Cuba-225-031-061A.jpg"
---
...
Slang like this only clicks when you hear it in real conversations. Our [Short Stories in Cuban Spanish](https://shop.digitalpolyglot.com/products/short-stories-in-cuban-spanish?utm_source=blog&utm_medium=referral&utm_campaign=20-cuban-spanish-slang-words-and-expressions) drop these words into everyday island scenes, so you learn the timing and the tone, not just a list.
...
3. **Meet the words in context.** The [Cuban Spanish Phrasebook](https://shop.digitalpolyglot.com/products/cuban-spanish-phrasebook?utm_source=blog&utm_medium=referral&utm_campaign=20-cuban-spanish-slang-words-and-expressions) gives you the everyday language these expressions live inside.
