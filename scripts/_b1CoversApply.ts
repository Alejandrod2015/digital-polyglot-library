/** Pone en el lector las 21 portadas del Traveler ES/latam B1 que llegaron por el
 *  artifact "Taller de portadas B1" (generadas a mano en otra laptop con el metodo
 *  del cast sheet). Misma persistencia que la ruta del estudio
 *  `api/studio/journeys/cover-upload`: sube el PNG a R2, calcula el thumbhash y
 *  escribe coverUrl + coverThumbhash + coverDone en la historia.
 *
