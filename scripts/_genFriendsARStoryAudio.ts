/**
 * Narración single-voice (Narrator AR - Renzo, APROBADO) para Friends ES Argentina C1.
 * Estilo NARRADOR: una sola voz narra las 21. No pisa audio existente. GATED (ElevenLabs). Uso:
...
const NARRATOR = "acHf5gp7AGOY30tJjvD4"; // Renzo (porteño; APROBADO por el usuario, ya narra Friends C1 LATAM tema BA; en allowlist)
