...
P = [
 ...
 ("t3",1,"avoir besoin",{"surface":"besoin"}),
 ("t3",2,"avoir raison",{"surface":"raison"}),
 ("t3",0,"merci beaucoup",{"word":"merci","surface":"Merci","type":"expression","definition":"Thank you; what you say when someone helps."}),
