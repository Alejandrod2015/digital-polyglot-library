/** Pone en el lector las 21 portadas del Traveler ES/spain B2 que llegaron por
 *  Drive (generadas a mano en otra laptop con el metodo del cast sheet). Misma
 ...
 *  coverDone en la historia. Adaptado de scripts/_b1CoversApply.ts (worktree
 *  kind-wilson-3e8650), con la comprobacion de 21 intacta.
 *
 *  uso: NODE_OPTIONS="-r ./scripts/_envBoth.cjs" npx tsx scripts/_b2sCoversApply.ts <mapa.json> [--dry]
...
const JOURNEY = "cmtplpfum0007j8c6piegwt31";
