...
ejercicios = [
 ...
 # pool
 M("Yo también", "[[Yo también]] tiendo ropa.", "me too", ["not me", "of course", "back then"]),
 ...
 M("hace tres años", "Es de [[hace tres años]].", "from three years ago", ["from a market stall", "from my brother", "from a school trip"]),
