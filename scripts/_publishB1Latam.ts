/**
 * Publica el Traveler ES/latam B1: pasa las 21 historias a `published` y el
 ...
 *
 *   npx tsx scripts/_publishB1Latam.ts --dry
 *   npx tsx scripts/_publishB1Latam.ts --apply
...
const JOURNEY_ID = "cmtmylg7k0007321h6t7njesx";
