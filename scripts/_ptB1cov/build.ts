  ...
  },
  {
    ...
    stories: [
      ...
      { slug: "o-quarto-morno-da-pousada", title: "O quarto morno da pousada", slot: 2, note: "",
        scene: "The small reception desk of a guesthouse in Recife at one in the morning, lit by one warm table lamp. NILZA has stepped out from behind the desk with a cup of coffee in one hand, showing a slow breath with her other hand on her chest; RENATA stands facing her in her jacket, arms wrapped around herself, tired. A ceiling fan, a closed wooden door and a dark window. Close medium shot from slightly above, both waist-up." },
  ...
  },
  {
    ...
    stories: [
      ...
      { slug: "a-lagoa-entre-as-dunas", title: "A lagoa entre as dunas", slot: 3, note: "",
        scene: "A wide shallow turquoise lagoon between white sand dunes at dawn, a pale moon low in a pink sky. RENATA stands waist-deep in the clear water with her arms open, laughing; DAMIÃO stands on the sand at the edge beside the beached canoe, one foot digging into the sand, watching her. A small green plant with one white flower on the dune. Very wide shot from the top of a dune, both full body." },
    ],
  },
  {
    ...
    stories: [
      ...
      { slug: "a-senhora-nao-dorme", title: "A senhora não dorme?", slot: 2, note: "CLEIDE no sale: la escena es el viaje nocturno. El motorista y el pasajero que ronca no se dibujan.",
        scene: "Inside a long-distance bus at night, dark blue light and an empty aisle. RENATA sits alone on a narrow window seat, awake, one hand gripping the seat back in front, looking out at the dark road; the seat next to her is empty. Rows of empty seat backs and the orange glow of a traffic light through the wet window. Close shot from the aisle, RENATA waist-up." },
  ...
  },
  {
    ...
    stories: [
      { slug: "nada-minha-filha", title: "Nada, minha filha", slot: 1, note: "",
        scene: "The open door of a small corner laundry on a cold grey afternoon in Gramado, wooden houses and pine trees behind. NEUZA hangs wet socks on a long wooden pole; RENATA stands beside an open brown cardboard box, pulling a thick red jumper over her head. A green scarf and a single grey glove on top of the box. Wide shot from the street, both full body." },
      { slug: "a-fronha-gelada", title: "A fronha gelada", slot: 2, note: "",
        scene: "Inside the warm laundry at dusk, lit by one yellow lamp. NEUZA pours tea from a metal kettle into a worn mug; RENATA holds the mug with both hands close to her face, her closed notebook tucked under one arm. Folded towels on a shelf and steam rising from the mug. Close medium shot, both waist-up." },
