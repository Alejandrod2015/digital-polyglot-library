...
T = [
 ...
 ("work-and-shifts", "Work & Shifts", ["ELISA", "DAVIDE", "NICOLA"], DOG + COLLAR, [
  ("quattro-sabati-per-nicola", "Quattro sabati per Nicola", 1,
   "On a quiet NoLo street in Milan outside a plain post office doorway with no sign, early afternoon, the dappled shade of a big plane tree on the pavement, a pale-yellow building behind. NICOLA sits astride a plain yellow bicycle with no markings, one foot on the ground, turning back over his shoulder with a sly grin and holding up four fingers of one hand; DAVIDE stands beside the bicycle with one hand on his chest, grateful and relieved; ELISA stands a step back in the shade holding BISCOTTO's lead, frowning at DAVIDE. Medium shot, all three waist up or fuller.", ""),
 ...
 ("summer-and-holidays", "Summer & Holidays", ["ELISA", "DAVIDE", "GABRIELE"], DOG + COLLAR, [
  ...
  ("davide-torna-prima", "Davide torna prima", 3,
   "On an empty platform of Milano Centrale at five o'clock in the morning, pale pink dawn light through the great arched iron-and-glass roof, a plain grey train with no markings. DAVIDE steps down from the train with a dark-blue backpack on one shoulder, slightly sun-tanned, grinning; BISCOTTO leaps up at him on its lead; ELISA stands on the platform holding the lead with both hands, moved and grateful. Medium shot, both waist up or fuller; the platform is completely empty of other people.", "Gabriele no sale. Anden vacio y tren sin rotulos ni paneles."),
 ]),
