...
T = [
 ("birthdays-and-wishes", "Birthdays & Wishes", ["ALICE", "MATTEO"], [
  ...
  ("e-solo-uno-scherzo", "È solo uno scherzo", 2,
   f"On {TERRACE}, evening, warm lamp light, a cake with a few slices missing and plain thin blown-out candles on the table. MATTEO leans across the table holding out a small folded paper napkin, clearly old with yellow-brown stains and creases, laughing. ALICE holds a wine glass raised right up in front of her mouth and nose, hiding most of her face behind the glass; only her eyes show above the rim, wide and uneasy, not smiling, avoiding his gaze. Medium shot across the table, both waist up.", "La servilleta del pacto va doblada: la historia la lee en voz alta, pero en la portada nunca se ve escrita. Reintento tras defecto: la 1a tirada saco a Alice sonriendo abiertamente en vez de ocultar la cara tras la copa, y la servilleta salio limpia en vez de vieja y manchada; esta version ancla las dos cosas en la escena, no solo en el nombre del objeto."),
