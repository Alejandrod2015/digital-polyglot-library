...
d["bundles"]["portuguese-traveler-brazil-a2"] = {
    ...
    "characterNames": ["renata", "gilson", "alegre", "nilza", "edilson", "jericoacoara", "damião", "lençóis", "cleide", "aquidauana"],
    "numerals": ["dez", "dezoito", "dois", "doze", "duas", "nove", "quatro", "seis", "sete", "três", "vinte"],
}
