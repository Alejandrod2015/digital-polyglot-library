...
const DE_IRR: Record<string, { presente: string[]; "pretérito": string[] }> = {
  ...
  schlafen:{ presente: ["schlafe","schläfst","schläft","schlafen","schlaft","schlafen"], "pretérito": ["schlief","schliefst","schlief","schliefen","schlieft","schliefen"] },
  schlagen:{ presente: ["schlage","schlägst","schlägt","schlagen","schlagt","schlagen"], "pretérito": ["schlug","schlugst","schlug","schlugen","schlugt","schlugen"] },
  wachsen: { presente: ["wachse","wächst","wächst","wachsen","wachst","wachsen"], "pretérito": ["wuchs","wuchsest","wuchs","wuchsen","wuchst","wuchsen"] },
