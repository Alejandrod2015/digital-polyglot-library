...
const SCENES: Record<string, string> = {
  "la-barra-manda":
    "The inside of a small village bar in Andalusia, full at dinner time. IRENE stands at the crowded bar counter ordering, facing the owner, an adult man of about forty working behind the bar; beside her another adult man reads a folded newspaper with a drink. Behind them, one empty table at the back of the room and other adults eating at the rest. Whitewashed walls, warm bright light, lively mood.",
  "nadie-ha-pedido-esa-tapa":
    "A busy bar counter in an Andalusian village on a summer evening. IRENE stands at the counter looking with puzzled surprise at a small plate of food that has arrived beside her drink without being ordered; the owner, an adult man of about forty, works behind the bar without looking up; on her other side an adult man holds up his own identical small plate to show her. Whitewashed walls, hanging hams and bottles behind the bar, warm bright light.",
  ...
  "el-paquete-duerme-cuatro-meses":
    "Early morning at the door of a small whitewashed flat in an Andalusian village, seen from across the street so the two figures are small in the frame. ROCÍO stands in the doorway holding out a brown paper parcel tied with string; IRENE stands in her own doorway looking at the parcel with puzzled amusement, one hand still on the door. Narrow white street behind them, soft early light, calm friendly mood.",
