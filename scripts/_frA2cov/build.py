...
C = {
 ...
 "JULIEN": "man, exactly 34 years old, stocky build, a little shorter than ROMAIN, light-tanned skin, short dark-brown hair under a plain BLACK BASEBALL CAP with no logo (a soft cloth cap with a curved brim, NEVER a hard hat, safety helmet or construction helmet of any colour), clean-shaven, no glasses; wears a plain grey hoodie, black work trousers and black safety boots",
...
T = [
 ...
 ("housework-and-fairness", "Housework & Fairness", ["ROMAIN", "JUSTINE", "JULIEN"], [
  ("julien-compte-les-points", "Julien compte les points", 1,
   f"Inside the open side door of a plain white work van with no markings, parked on a Nantes building site at lunch break, coils of cable and toolboxes around them, bright daylight. No hard hats, safety helmets or high-vis vests are visible anywhere in the scene. JULIEN sits holding his phone up with its plain back to the viewer, the screen turned towards ROMAIN, explaining proudly, his plain black baseball cap on his head; ROMAIN sits beside him with a half-eaten baguette sandwich, nodding, impressed. Medium shot, both waist up.", "Justine no sale: solo se la nombra. CORRECCION 2026-09-15: la tirada anterior salio con Julien con un casco amarillo de obra en vez de la gorra negra de la ficha (defecto de reparto, descarte automatico). Reforzada la ficha y la escena en positivo + negacion explicita contra el casco."),
