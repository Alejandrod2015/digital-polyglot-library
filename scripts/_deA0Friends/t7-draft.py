...
s0 = "\n\n".join([
 "Eine Notiz klebt an Annas Tür. Die Schrift ist ordentlich. Anna, die Mieterin auf Probe, lehnt am Geländer und liest. Die Notiz ist höflich.",
...
s1 = "\n\n".join([
 ...
 "Anna ist ratlos, denn beide Spalten sind fast gleich lang. Sie kaut auf dem Kuli.",
...
s2 = "\n\n".join([
 ...
 "Jan wartet in der Küche mit zwei Gläsern Sekt. Die Gläser klirren.",
