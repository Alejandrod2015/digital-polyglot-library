...
async function main() {
  ...
  await p.journeyStory.update({ where: { id: s.id }, data: {
    audioUrl: null, audioFilename: null, audioSegments: undefined, audioFragments: undefined,
    audioWordTimings: undefined, audioStatus: "pending", audioQaStatus: null, audioQaScore: null, audioQaNotes: null } });
