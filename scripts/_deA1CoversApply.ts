/** Sube las portadas del Friends DE A1 (Frankfurt) que llegaron a mano en
 *  /private/tmp/cover-inbox/alemania-a1-friends/. Adaptado de
 *  _frA2CoversApply.ts (commit 9eb20aa3): acepta un mapa PARCIAL, las
 *  historias sin entrada se quedan sin portada (defecto detectado en
 *  revision, ej. 4.2 con marca de agua).
 ...
 *    DOTENV_CONFIG_PATH=.env.local npx tsx scripts/_deA1CoversApply.ts <mapa.json> [--dry]
