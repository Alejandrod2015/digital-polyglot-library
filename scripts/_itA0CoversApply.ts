/** Sube las portadas del Friends IT A0 (Genova) que llegaron a mano en
 *  /private/tmp/cover-inbox/italia-a0-friends/. Acepta un mapa PARCIAL:
 *  las historias sin entrada en el mapa se quedan sin portada (defecto
 *  detectado en revision, ej. e-solo-uno-scherzo).
 ...
 *    DOTENV_CONFIG_PATH=.env.local npx tsx scripts/_itA0CoversApply.ts <mapa.json> [--dry]
