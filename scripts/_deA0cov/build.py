...
C = {
 ...
 "NIKLAS": "man, exactly 36 years old and looking no older than that, heavy build with a round belly, a little shorter than JAN, smooth unwrinkled face, ruddy fair skin, short brown hair with only faint early strands of grey at the temples (never fully grey), clean-shaven, thin rectangular black-framed glasses; wears a brown wool sweater over a checked shirt collar, grey trousers and brown leather loafers",
}
