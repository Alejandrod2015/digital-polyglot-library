 ...
 * Traveler DE A0, por el MISMO camino que el render completo
 ...
 * El segundo mp3 lleva ya el pacing del journey (atempo hacia 2,4 pal/s),
...
async function run() {
  ...
  const slug = args.find((a) => !a.startsWith("--")) ?? "wieder-in-dresden";
  ...
  assertVoiceApproved(story.voiceId, `de-a0-muestra:${slug}`);
