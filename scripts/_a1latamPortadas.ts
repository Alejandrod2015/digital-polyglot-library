/** Hoja unica de portadas del A1 latam: las 21 en una sola pantalla, sin
 *  scroll, una columna por tema y una fila por historia. Sirve para juzgar
 *  COHERENCIA entre portadas; los defectos de una se miran a tamano completo,
 *  y para eso cada casilla se abre en grande al hacer clic.
 *
 *  uso: OUT=<dir> npx tsx scripts/_a1latamPortadas.ts */
...
<meta charset="utf-8">
<title>Portadas del A1 latam</title>
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .col { min-height:0; display:grid; grid-template-rows:auto repeat(3, 1fr); gap:8px; }
...
<header>
  <h1>Portadas del A1 latam</h1>
  <span class="cuenta">${hechas} de 21 · clic en una para verla grande</span>
</header>
<div class="rejilla">
${celdas.join("\n")}
</div>
...
<script>
  ...
  console.log(`${hechas}/21 portadas · ${path.join(out, "index.html")}`);
  await p.$disconnect();
})();
