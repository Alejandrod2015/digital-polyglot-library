/**
 * Narra UNA historia, entera, con el narrador de su perfil. El entregable es
 * ese audio completo y el usuario lo pidio: por eso corre con el opt-in
 * consciente DPL_AUDIO_FULL_OK=1 del guard 6d (sample-first).
 *
 ...
 *         npx tsx scripts/_narraUnaA2.ts <slug> [--journey a2 | b1-latam | b2-latam | spain-b1 | spain-b2]
 *
 * Antes de narrar, el modo en seco dice que voz y que paso del orden toca a
 * cada historia, con las mismas funciones (si existe):  npx tsx scripts/_narraSeco.ts --journey <perfil>
 */
...
// el B2 spain (pedir-una-vez): los perfiles viven en _narraPerfiles.ts; sin
// flag, el A2.
