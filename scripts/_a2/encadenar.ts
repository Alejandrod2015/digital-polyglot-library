/**
 * Encadena los journeys de Espana: a0 Friends -> a1 Traveler -> a2 Traveler -> b1 Traveler.
 *
...
const A2 = "cmt70xfyt000l3283gxd70wck"; // Traveler spain a2
const B1 = "cmt5x67ze000l320cpgunu5vi"; // Traveler spain b1
(async () => {
  const dry = process.argv.includes("--dry");
  for (const [de, a] of [[A0, A1], [A1, A2], [A2, B1]] as const) {
