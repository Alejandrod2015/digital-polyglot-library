/**
 * Contact sheet de las portadas del A2 ES/Spain, en ORDEN DE LECTURA.
 *
 ...
 *
 *   npx tsx scripts/_a2/muralPortadas.ts [salida.png]
 *
...
void (async () => {
  const salida = process.argv[2] ?? "a2-covers.png";
...
`;
  ...
  const { stdout } = await exec("/Users/alejandrodelcarpio/digital-polyglot-library/.venv-cv/bin/python", [script, ...fichas, "--", ...titulos, salida]);
