/**
 * Publica el journey Traveler ES latam A1: pasa las 21 historias a
 ...
 *
 *   npx tsx scripts/_publishA1Latam.ts --dry     (solo comprueba)
 *   npx tsx scripts/_publishA1Latam.ts --apply
 */
