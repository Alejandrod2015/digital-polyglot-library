/** Pone en el lector las 21 portadas del Friends FR A0 (Marseille) que llegaron
 *  por Drive (carpeta francia-a0, generadas en la laptop 2 con el metodo del cast
 *  sheet). Misma persistencia que la ruta del estudio
 ...
 *
 *  uso: NODE_OPTIONS="-r ./scripts/_envBoth.cjs" npx tsx scripts/_frA0CoversApply.ts <mapa.json> [--dry]
