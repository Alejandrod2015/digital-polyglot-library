...
const CAPA: Record<string, E[]> = {
  "la-cortesia-mas-cara": [
    ...
    { claves: ["elogio"], t: "noun", g: "praise", es: "El elogio ya decía que no", en: "the praise was already saying no" },
    { claves: ["tela", "telas"], t: "noun", g: "fabric", es: "elogió cada tela", en: "praised every fabric" },
    ...
    { claves: ["desinflarse", "se desinflaba"], t: "verb", g: "deflated (desinflarse)", es: "mientras el orgullo se desinflaba", en: "while her pride deflated" },
    { claves: ["almorzar", "almorzando"], t: "verb", g: "having lunch (almorzar)", es: "se cerraban almorzando", en: "got closed over lunch" },
  ...
  "yo-no-fallo": [
    ...
    { claves: ["madrugada"], t: "noun", g: "the small hours", es: "cosió de madrugada", en: "sewed in the small hours" },
    { claves: ["culpa"], t: "noun", g: "guilt", es: "La culpa se quedó despierta", en: "the guilt stayed awake" },
    { claves: ["puntada"], t: "noun", g: "stitch", es: "Cada puntada a la medida del logo", en: "every stitch measured to the logo" },
    { claves: ["encargo"], t: "noun", g: "order, commission", es: "había un solo encargo", en: "there was a single order" },
    ...
    { claves: ["apurar", "apuró"], t: "verb", g: "hurried (apurar)", es: "apuró Aurelio por teléfono", en: "Aurelio pressed her over the phone" },
    { claves: ["timbrar", "timbró"], t: "verb", g: "rang the doorbell (timbrar)", es: "timbró con un vestido", en: "rang the bell with a dress" },
  ...
  "una-yapa-de-sobremesa": [
    ...
    { claves: ["acordar", "acordaron"], t: "verb", g: "they agreed on (acordar)", es: "Acordaron la cifra a medias", en: "they agreed on the figure halfway" },
    ...
    { claves: ["cerrar el trato", "cerraron el trato"], t: "expression", g: "close the deal", es: "Cerraron el trato con un apretón", en: "they closed the deal with a handshake" },
    { claves: ["hacerse de rogar", "se hacía de rogar"], t: "expression", g: "played hard to get", es: "él se hacía de rogar", en: "he played hard to get" },
    { claves: ["toma y daca"], t: "expression", g: "give and take", es: "Un toma y daca tan educado", en: "such a polite give and take" },
    { claves: ["sacar en limpio", "sacaron en limpio"], t: "expression", g: "write out the final version", es: "la sacaron en limpio en una servilleta", en: "they wrote the clean version on a napkin" },
