...
const CAPA: Record<string, E[]> = {
  "la-otra-columna": [
    ...
    { claves: ["medialuna", "medialunas"], t: "noun", g: "Argentine sweet croissant", es: "olía a café con medialunas", en: "smelled of coffee and croissants" },
    ...
    { claves: ["dictar", "dictaba"], t: "verb", g: "teaches, delivers (dictar)", es: "historias que dictaba despacio", en: "stories she delivered slowly" },
    ...
    { claves: ["aula"], t: "noun", g: "classroom", es: "en un aula que olía a café", en: "in a classroom that smelled of coffee" },
    { claves: ["pelear", "peleó"], t: "verb", g: "fought (pelear)", es: "No lo peleó", en: "she did not fight it" },
    ...
    { claves: ["tragarse el orgullo", "tragó el orgullo"], t: "expression", g: "swallow your pride", es: "Se tragó el orgullo", en: "she swallowed her pride" },
  ...
  "buena-suerte-en-porteno": [
    ...
    { claves: ["parecerse", "se parecía"], t: "verb", g: "resembled (parecerse)", es: "no se parecía a nada", en: "was like nothing else" },
    { claves: ["mejorar", "mejoren"], t: "verb", g: "improve (mejorar)", es: "Cuando los números mejoren", en: "when the numbers improve" },
    { claves: ["avanzar", "avanzaban"], t: "verb", g: "advanced (avanzar)", es: "los módulos avanzaban solos", en: "the modules advanced on their own" },
    { claves: ["tomar lista", "tomaba lista"], t: "expression", g: "call the roll", es: "Tomaba lista sin apuro", en: "she called the roll without hurry" },
    { claves: ["levantar la mano", "levantaba la mano"], t: "expression", g: "raise your hand", es: "nadie levantaba la mano", en: "nobody raised a hand" },
    { claves: ["buena suerte"], t: "expression", g: "good luck", es: "cómo se decía buena suerte", en: "how you said good luck" },
    { claves: ["sin apuro"], t: "expression", g: "without hurry", es: "Tomaba lista sin apuro", en: "she called the roll without hurry" },
  ...
  "que-buena-idea-ariel": [
    ...
    { claves: ["despegar", "despegó"], t: "verb", g: "peeled open (despegar)", es: "despegó el sobre pendiente", en: "peeled open the pending envelope" },
    ...
    { claves: ["aplaudir", "aplaudieron"], t: "verb", g: "clapped (aplaudir)", es: "aplaudieron bajito", en: "clapped softly" },
    { claves: ["acordarse", "me acuerdo"], t: "verb", g: "I remember (acordarse)", es: "me acuerdo de los cuentos", en: "I remember the stories" },
    { claves: ["pararse", "se paró"], t: "verb", g: "stood (pararse)", es: "se paró en la puerta", en: "stood at the door" },
