...
const CAPA: Record<string, E[]> = {
  "vitel-tone-con-blanco": [
    ...
    { claves: ["anillo", "anillos"], t: "noun", g: "ring", es: "el anillo que Norma hacía girar", en: "the ring Norma spun around" },
    ...
    { claves: ["fijarse", "se fijó"], t: "verb", g: "noticed (fijarse)", es: "se fijó en todo", en: "noticed everything" },
    { claves: ["hacer girar", "hacía girar"], t: "expression", g: "spins around", es: "que Norma hacía girar cuando dudaba", en: "that Norma spun when she hesitated" },
    ...
    { claves: ["sobre todo"], t: "expression", g: "above all", es: "era sobre todo Norma", en: "was above all Norma" },
  ...
  "aca-los-errores-se-pagan": [
    ...
    { claves: ["hornalla"], t: "noun", g: "stove burner (Argentina)", es: "la hornalla no esperaba a nadie", en: "the burner waited for nobody" },
    { claves: ["tanda"], t: "noun", g: "batch", es: "la primera tanda de milanesas salió dorada", en: "the first batch of milanesas came out golden" },
    { claves: ["rebozar"], t: "verb", g: "to coat for frying (rebozar)", es: "¿Sabés rebozar, nene", en: "do you know how to bread, kid" },
    { claves: ["quemarse", "se quemó"], t: "verb", g: "burned (quemarse)", es: "se pasó de punto y se quemó", en: "went past the point and burned" },
    { claves: ["dorado", "dorada"], t: "adjective", g: "golden brown", es: "salió dorada", en: "came out golden brown" },
    { claves: ["clienta"], t: "noun", g: "customer (woman)", es: "atendía a una clienta", en: "was helping a customer" },
    { claves: ["cumplido"], t: "noun", g: "compliment", es: "no dijo nada, que era un cumplido", en: "said nothing, which was a compliment" },
    { claves: ["consolar", "consoló"], t: "verb", g: "comforted (consolar)", es: "no gritó ni consoló", en: "neither shouted nor comforted" },
    { claves: ["valer", "valía"], t: "verb", g: "was worth (valer)", es: "la cuenta de lo que valía", en: "the sum of what it was worth" },
    { claves: ["tirar", "tiró"], t: "verb", g: "tossed (tirar)", es: "le tiró un delantal", en: "tossed him an apron" },
    { claves: ["doblado"], t: "adjective", g: "folded", es: "se lo llevó doblado", en: "took it home folded" },
    { claves: ["sacar la cuenta", "sacó la cuenta"], t: "expression", g: "work out the cost", es: "sacó la cuenta de lo que valía", en: "worked out what it was worth" },
    { claves: ["pasarse de punto", "se pasó de punto"], t: "expression", g: "get overcooked", es: "se pasó de punto y se quemó", en: "went past the point and burned" },
    { claves: ["sin chistar"], t: "expression", g: "without protest", es: "Pagó sin chistar", en: "paid without a word of protest" },
    { claves: ["a la hora de", "la hora de cerrar"], t: "expression", g: "when it is time to", es: "hasta la hora de cerrar", en: "until closing time" },
    { claves: ["abrir la caja", "abrió la caja"], t: "expression", g: "open the till", es: "abrió la caja", en: "opened the till" },
  ...
  "la-ultima-dorada": [
    ...
    { claves: ["darse vuelta"], t: "expression", g: "turn around", es: "se fue sin darse vuelta", en: "left without turning around" },
    ...
    { claves: ["cobrar", "cobró"], t: "verb", g: "charged (cobrar)", es: "Atendió, cobró, rebozó", en: "served, charged, breaded" },
    ...
    { claves: ["contado", "contada"], t: "adjective", g: "counted", es: "La plata estaba contada dos veces", en: "the money was counted twice" },
    ...
    { claves: ["parado", "parada"], t: "adjective", g: "standing", es: "la probó ahí parada", en: "tasted it standing right there" },
