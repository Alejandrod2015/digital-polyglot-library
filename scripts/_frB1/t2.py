...
v2=[
 ...
 v("le fleuriste","fleuriste","noun","a person who sells flowers in a shop",True),
...
v3=[
 ...
 v("la lampe de poche","lampe de poche","noun","a small light with batteries that you carry in your hand",True),
 ...
 v("le câble","câbles","noun","a thick wire that carries electricity from one place to another",True),
 ...
 v("l'électricien","électricien","noun","a person whose job is to install and repair electrical wires",True),
 v("le papier alu","papier alu","noun","thin silver metal paper used to wrap food",True,register="colloquial"),
