...
vocab=[
 ...
 ("adjective","nett",None,"Nice and friendly, the way strangers can be at a long table."),
...
Max: Ben kam aus Hamburg, Clara aus Leipzig, jeder mit neuem Beruf und ohne Freunde.
Sofie: Dann ist dieses Gespräch kein Zufall.
Max: Nein. So fängt eine Freundschaft an, in einer fremden Stadt.""",
vocab=[
 ...
 ("noun","Wort",None,"A word; the single one written on the sign."),
 ("noun","Stadt",None,"A city; the place Sofie moved to two weeks ago."),
 ("adjective","fremd",None,"Strange and unknown, the way a new city feels at first."),
