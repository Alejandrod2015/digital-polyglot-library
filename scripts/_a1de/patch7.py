...
Hanna legt die Hand auf den Ring und fühlt darüber. Dann runzelt sie die Stirn.
...
vocab=[
 ("noun","Licht",None,"Light; here the last daylight before the sun goes down."),
 ...
 ("noun","Ring",None,"A ring; here the round iron handle fixed on the castle gate."),
 ("adjective","eisern","eisernen","Made of iron; hard grey metal used for gates and tools."),
 ("verb","beißen","gebissen","To bite; to close your teeth hard on something."),
 ("noun","Geschichte",None,"A story; something people tell, true or made up."),
 ("noun","Wunder",None,"A wonder; an event so strange that it cannot be explained."),
 ("adjective","schwarz",None,"Black; the darkest colour, the colour of night without light."),
 ("noun","Wetter",None,"The weather; sun, rain and wind, which slowly damage old metal."),
 ("noun","Zahn","Zähnen","A tooth; one of the hard white parts in your mouth."),
 ("verb","fühlen","fühlt","To feel; to touch something to find out how it is."),
 ("verb","runzeln","runzelt","To wrinkle; to pull your forehead together when you think hard."),
 ("noun","Stirn",None,"The forehead; the flat part of your face above the eyes."),
 ("noun","Kerbe",None,"A notch; a small deep cut in wood, stone or metal."),
 ("adverb","woher",None,"From where; used to ask about the origin of something."),
 ("noun","Nacht",None,"The night; the dark hours between evening and the next morning."),
])
...
vocab=[
 ...
 ("noun","Steintreppe",None,"A stone staircase; steps cut from stone in an old building."),
 ("adverb","hinunter",None,"Downwards; from up here to a lower place, for example a cellar."),
 ("noun","Kellertür",None,"The cellar door; the door between the house and the rooms below."),
 ("adjective","riesig","riesiges","Huge; very big indeed, much bigger than you expected."),
 ("noun","Weinfass",None,"A wine barrel; the big round wooden cask that holds wine."),
 ("noun","Wein",None,"Wine; the drink made from grapes that Germany stores in barrels."),
 ("verb","lagern","gelagert","To store; to keep goods in one place for a long time."),
 ("noun","Spinne","Spinnen","A spider; the small animal with eight legs that makes webs."),
 ("noun","Maus","Mäuse","A mouse; the small grey animal that lives in old buildings."),
 ("noun","Ratte",None,"A rat; the bigger grey animal that lives in cellars and drains."),
 ("noun","Taschenlampe",None,"A torch; the small lamp you hold in your hand in the dark."),
...
vocab=[
 ...
 ("adverb","hinaus",None,"Out; from inside a room to the open air outside."),
 ("noun","Flügel",None,"A wing; the part a bird moves up and down in order to fly."),
 ("noun","Gespenst",None,"A ghost; the spirit of a dead person in old scary stories."),
 ("noun","Nachtvogel",None,"A night bird; a bird that is awake and hunts after dark."),
 ("noun","Angst",None,"Fear; the bad feeling you get when you think something will hurt you."),
 ("adjective","weit",None,"Wide; open as far as it can go, here a window."),
