...
vocab=[
 ...
 ("verb","umziehen",None,"To move house; to take your things to a new home and live there."),
 ...
 ("noun","Kindheit",None,"Childhood; the years of your life when you were still a child."),
 ("noun","Erinnerung","Erinnerungen","A memory; a picture in your head of something that happened before."),
])
...
vocab=[
 ...
 ("adverb","hinauf",None,"Upwards; from down here to a higher place, for example up stairs."),
 ("noun","Stock",None,"A floor of a building, counted upwards from the ground floor."),
 ("noun","Aufzug",None,"A lift; the small moving room that carries people up a building."),
 ("noun","Bücherkiste",None,"A box full of books, the heaviest thing in almost every move."),
 ...
 ("adjective","möglich",None,"Possible; it can really happen or can really be true."),
...
vocab=[
 ...
 ("noun","Wohnzimmer",None,"The living room, where people sit together, talk and rest."),
 ("noun","Wand","Wand","A wall; one of the flat sides that close a room in."),
