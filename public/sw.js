// SW build tag: 2026-05-17T17-bump-loading-fix (byte-diff forces Chrome
// to re-install this worker on next page load, which in turn refreshes
// any leftover state from the previous self-unregistering worker).
