...
const PASS_LABELS: Record<string, string> = {
  ...
  "vocab-count": "Cantidad de vocab correcta (20 a techo según densidad)",
...
export function humanize(check: Check): Humanized {
  ...
  switch (id) {
    ...
    case "vocab-count":
      return {
        text: `El vocab tiene ${numStr} items (mínimo 20; el techo escala con la densidad del cuerpo)`,
