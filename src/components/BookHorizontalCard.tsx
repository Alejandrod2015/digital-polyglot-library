...
export default function BookHorizontalCard({
  ...
  return (
    <Link
      href={href}
      className="flex items-center gap-5 w-full bg-white/5 rounded-2xl p-5 cursor-pointer hover:bg-white/10 hover:shadow-md transition-all duration-200 h-full min-h-[220px] md:min-h-[230px]"
    >
