...
const ACCENT_SOFT = "color-mix(in srgb, var(--studio-accent) 15%, transparent)";
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      {message && (
        <div style={{
          ...
          fontSize: 13,
          fontWeight: 500,
          backgroundColor: message.type === "ok" ? "color-mix(in srgb, var(--studio-accent) 12%, transparent)" : "rgba(239, 68, 68, 0.12)",
          color: message.type === "ok" ? ACCENT : "#ef4444",
          border: `1px solid ${message.type === "ok" ? "color-mix(in srgb, var(--studio-accent) 30%, transparent)" : "rgba(239, 68, 68, 0.3)"}`,
        }}>
          {message.text}
        </div>
      )}
