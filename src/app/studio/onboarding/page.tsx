  ...
  return (
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <section
          style={{
            background: "linear-gradient(135deg, color-mix(in srgb, var(--studio-accent) 10%, transparent), color-mix(in srgb, var(--studio-accent) 2%, transparent))",
            border: `1px solid color-mix(in srgb, var(--studio-accent) 28%, transparent)`,
            borderRadius: 12,
            padding: "16px 18px",
          }}
        >
