...
const STATUS_COLORS: Record<Status, string> = {
  ...
  qa_fail: "#f59e0b", needs_review: "#f59e0b", approved: "var(--studio-accent)", published: "#10b981",
};
...
const pill = (active: boolean): React.CSSProperties => ({
  ...
  backgroundColor: active ? "var(--studio-accent, var(--studio-accent))" : "rgba(127,127,127,0.1)",
...
const actionBtn = (color: string, disabled: boolean): React.CSSProperties => ({
  ...
  color: "#fff", backgroundColor: disabled ? `color-mix(in srgb, ${color} 38%, transparent)` : color,
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 6, flexWrap: "wrap" }}>
        ...
        <button onClick={handleAutoPromote} disabled={promoting}
          style={{ ...actionBtn("var(--studio-accent)", promoting), fontSize: 11, padding: "3px 10px" }}>
          ...
          {drafts.map((d) => (
            <div key={d.id}>
              ...
              <div
                ...
                onMouseEnter={(e) => { e.currentTarget.style.background = "color-mix(in srgb, var(--studio-accent) 4%, transparent)"; }}
              ...
              >
                ...
                <span style={{
                  ...
                  {langLevel(d.metadata) && (
                    <span style={{ marginLeft: 4, fontSize: 10, color: "var(--studio-accent)", fontWeight: 600 }}>
                      {langLevel(d.metadata)}
                    </span>
                  )}
                </span>
