...
export default async function StudioUserJourneyPage() {
  ...
  return (
    <StudioShell
      title="User Journey"
      description="El recorrido de un usuario nuevo en la app iOS, de la bienvenida al hábito diario, en 20 pantallas reales (incluido el journey guiado con progreso). Al final, la capa de beta: dónde y cuándo se pide feedback."
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        >
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            {["20 pantallas", "+ 6 de feedback beta", "iOS · producción", "Journey LATAM"].map((chip) => (
              <span
                key={chip}
                style={{
                  fontSize: 12,
