...
const statCard: React.CSSProperties = { background: "var(--mx-bg-2)", border: "1px solid rgba(148,163,184,0.18)", borderRadius: 10, padding: "12px 14px" };
...
const tableWrap: React.CSSProperties = { background: "var(--mx-bg-2)", border: "1px solid rgba(148,163,184,0.18)", borderRadius: 10, overflow: "hidden" };
