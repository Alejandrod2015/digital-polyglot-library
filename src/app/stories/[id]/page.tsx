...
export default async function StoryPage({ params }: StoryPageProps) {
  ...
  // ✅ Tipado explícito para evitar 'any' o null
  ...
  // ✅ TypeScript ya entiende que 'story' no es null después del check anterior
  return (
    <div className="max-w-4xl mx-auto p-8 text-white pb-32">
      ...
      <div className="text-sm text-gray-400 mb-6 space-x-4">
        <span>
          <strong>Language:</strong> {story.language}</span>
        <span>
          <strong>Level:</strong> {story.level}</span>
      </div>

      {/* === Texto con vocabulario interactivo === */}
      <StoryReaderClient
        story={{
          id: story.id,
          title: story.title,
