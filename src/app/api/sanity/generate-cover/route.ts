...
function buildCoverPrompt(args: {
  ...
  return [
    ...
    "",
    "Visual direction:",
    "- Simple modern minimal editorial illustration.",
    "- Bold, vivid colors (clean and saturated) while keeping natural white balance.",
    "- Flat clean shapes, minimal texture, low visual noise.",
    "- Realistic skin tones and plausible ambient lighting.",
    "- Avoid sepia/yellow cast, avoid fantasy glow, avoid heavy filters, avoid neon/duotone look.",
