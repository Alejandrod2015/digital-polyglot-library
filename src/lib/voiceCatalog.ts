...
/** Engine-level pros/cons surfaced in the Studio gallery so we remember
 *  trade-offs at a glance (phantoms, license, expressivity, cost, etc.). */
...
export const ENGINE_INFO: Record<Engine, EngineInfo> = {
  ...
  elevenlabs: {
    ...
    cons: [
      ...
      "Términos: voces 'professional shared' caducan con 730 días notice del dueño.",
