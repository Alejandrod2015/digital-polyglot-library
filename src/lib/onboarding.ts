...
export const PRODUCT_TOUR_MESSAGES = [
  {
    ...
    targetLabel: "Home",
    title: "Your journey",
    body: "Home is your journey: a guided path of short stories that teach the real language in context. Start at the top and work your way down.",
  },
  {
    id: "explore",
    target: "explore",
    targetLabel: "Explore",
    title: "Explore",
    body: "Browse more stories and topics whenever you want to wander beyond your path.",
  },
  {
    id: "practice",
    target: "practice",
    ...
    title: "Practice",
    body: "Review and lock in the words you've learned with quick practice sessions.",
  },
  {
    id: "favorites",
    target: "favorites",
    ...
    title: "Favorites",
    body: "Save any word as you read and find all your favorites here to revisit.",
  },
] as const;
