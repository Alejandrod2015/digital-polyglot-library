...
export const colloquialgermanstories: Book = {
  ...
  "stories": [
    ...
    },
    {
      ...
      "text": "<p>Am Montagmorgen steht Lina am Bahnsteig und will einfach nur pünktlich zur Arbeit. In der U-Bahn ist sie schnell eingeklemmt im Gedränge, dann kommt die erste Durchsage: Störung, Verspätung, vielleicht sogar Ausfall. Die Leute werden genervt, niemand weiß, wie lange sie feststecken. Zwischen Fremden entsteht kurz echte Hilfe, und Lina merkt, dass so ein Chaos Entscheidungen plötzlich sehr dringend macht.</p>\n<p>Lina steht im Waggon und spürt sofort, dass der Morgen kippt. Bitte nicht heute, denkt sie. Nicht schon wieder so ein Start.</p>\n<p>Die Türen schließen, und sie ist fast eingeklemmt zwischen Jacken und Ellbogen. Vor ihr schiebt sich ein Gedränge, das keinen Platz für gute Laune lässt.</p>\n<blockquote>Wenn ich jetzt etwas sage, wird es nur schlimmer, sagt sie sich.</blockquote>\n<p>Dann kommt eine Durchsage, diese neutrale Stimme, die immer so tut, als wäre alles ganz normal. Es fällt das Wort Signalstörung, und Lina merkt, wie es in ihr knirscht. Das klingt nach Ärger. Das klingt nach warten.</p>\n<p>Der Zug rollt noch ein Stück und bleibt dann stehen. Ein kurzer Halt wird ein Ausfall, still und hartnäckig. Das wird eine halbe Ewigkeit, denkt Lina, obwohl sie die Uhr nicht sehen will.</p>\n<p>Als die Türen aufgehen, drückt die Menge hinaus. Lina landet draußen und schaut automatisch zur Anzeigetafel. Dort blinken Hinweise, und plötzlich steht da auch Ersatzverkehr.</p>\n<blockquote>Natürlich. Genau das brauche ich jetzt, denkt sie.</blockquote>\n<p>Neben ihr taucht ihr Sitznachbar von vorhin auf, nur ohne Sitz und ohne Eile im Gesicht. Lina macht ein kleines Augenrollen, mehr in sich hinein als nach außen. Der wirkt, als hätte er Zeit im Überfluss.</p>\n<p>Er sagt etwas Ruhiges, als wäre der Stillstand nur ein Umweg. Lina ist schon genervt, aber sie hört trotzdem zu.</p>\n<blockquote>Warum höre ich zu. Weil ich nichts anderes tun kann, denkt sie.</blockquote>\n<p>Ihr Blick fällt auf den Handy-Akku, der gefährlich niedrig ist.</p>\n<blockquote>Nicht auch das noch, denkt sie. Wenn der jetzt stirbt, stehe ich komplett im Dunkeln.</blockquote>\n<p>Hinter ihnen wird es laut, ein kleiner Ausraster mitten auf dem Bahnsteig. Jemand fängt an, andere Leute anzuschnautzen, als könnte man damit die Bahn reparieren. Lina merkt, wie ihr Magen fest wird.</p>\n<blockquote>Nicht reinziehen lassen, sagt sie sich. Einmal durchatmen.</blockquote>\n<p>Sie atmet langsam, zählt, und versucht, den Kopf wieder zu sortieren.</p>\n<p>Dann sagt Lina einen Satz, der nett gemeint ist, aber falsch landet. Ein Blick, ein Ton, und schon ist alles missverstanden.</p>\n<blockquote>Super. Jetzt habe ich auch noch Streit produziert, denkt sie.</blockquote>\n<p>Der Mann hebt kurz die Hand und macht es kleiner, nicht größer. Er erklärt ruhig, dass man am nächsten Knotenpunkt besser umsteigen kann. Lina merkt, wie sich die Spannung löst, als hätte jemand einen Knoten aufgemacht.</p>\n<p>Eine Frau neben Lina macht Platz, ohne etwas zu sagen. Es ist nur eine Bewegung, aber sie fühlt sich an wie ein stilles Zeichen.</p>\n<blockquote>Okay. Wir sind nicht alle gegeneinander, denkt Lina.</blockquote>\n<p>Als endlich wieder eine Bahn einfährt, wirkt sie nicht wie Rettung, eher wie ein neuer Versuch. Lina steigt ein, steht wieder dicht, aber innerlich leiser.</p>\n<blockquote>Das Chaos ist nicht weg, denkt sie. Es ist nur gerade unausweichlich.</blockquote>\n<p>Und trotzdem bleibt ein Gedanke hängen: Mit ein bisschen Geduld kommt man vielleicht doch durch diesen Morgen.</p>",
