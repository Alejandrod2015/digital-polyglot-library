...
export default function JourneyTopicBanner({
  ...
  return (
    <button
      ...
      className={`
        group w-full flex items-center gap-3.5 px-[22px] py-[22px]
        rounded-[22px] mb-8 relative cursor-pointer transition-[filter,transform,margin] duration-75
        hover:[filter:brightness(1.06)]
        active:translate-y-[3px] active:mb-[35px]
        disabled:cursor-not-allowed disabled:hover:[filter:none]
        shadow-[inset_0_2px_0_rgba(255,255,255,0.35),inset_0_-2px_0_rgba(0,0,0,0.20),0_5px_0_rgba(0,0,0,0.40),0_7px_18px_-8px_rgba(0,0,0,0.50)]
        active:shadow-[inset_0_2px_0_rgba(255,255,255,0.30),inset_0_-1px_0_rgba(0,0,0,0.15),0_2px_0_rgba(0,0,0,0.40)]
      `}
    >
